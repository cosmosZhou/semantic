...
/**
 * Applies basic filtering to words and phrases to produce candidates for
 * cluster labels. Filtering is applied to {@link AllWords} and
 * {@link AllPhrases}, the results are saved to {@link AllLabels}. Currently,
...
public class LabelFilterProcessor {
	// For the time being we include filters as instance fields here. If there is a
	// need
	// to add custom label filters as parameters, we'll need to come up with
	// something.
