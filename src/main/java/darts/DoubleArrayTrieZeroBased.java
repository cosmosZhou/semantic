...
public class DoubleArrayTrieZeroBased {
	@Override
	public boolean equals(Object _obj) {
		DoubleArrayTrieZeroBased obj = (DoubleArrayTrieZeroBased) _obj;
...
//		}
	...
	public DoubleArrayTrieZeroBased(List<String> list) {
		this(new TreeSet<String>(list));
	}

	public DoubleArrayTrieZeroBased(TreeSet<String> _key) {
...
//		new Utility.Text("../corpus/ahocorasick/small.txt").collect(words);
		...
		DoubleArrayTrieZeroBased dat = new DoubleArrayTrieZeroBased(words);
		...
		DoubleArrayTrieZeroBased _dat = new DoubleArrayTrieZeroBased(words);
		System.out.println("time cost = " + (System.currentTimeMillis() - start));
