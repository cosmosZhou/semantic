...
<div>
	insert into tbl_<%=table%>(text, translation, score) values( <input
		type=button
		onClick='add_translation_item(this.parentElement.getElementsByTagName("div")[0], "")'
		value=text> / <input id=file name=file type=file
		onchange='handleFiles(this, add_translation_item' value=text
